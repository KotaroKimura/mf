...
def login(email, password):
    ...
    elem_loginMethod = driver.find_element_by_xpath(
        '/html/body/main/div/div[2]/div/div/div[1]/section/form/div/div/input')
    elem_loginMethod.send_keys(email)

    elem_login = driver.find_element_by_xpath(
        '/html/body/main/div/div[2]/div/div/div[1]/section/form/div/div/div[3]/button')
    elem_login.click()
    sleep(3)

    elem_password = driver.find_element_by_xpath(
        '/html/body/main/div/div[2]/div/div/div[1]/section/form/div/div/div[2]/input')
    ...
    elem_choose_account = driver.find_element_by_xpath(
        '/html/body/main/div/div[2]/div/div/div[1]/section/form/div/div/div[2]/button')
